...
export default function Component() {
  ...
  const onSubmit = async (data: z.infer<typeof FormSchema>) => {
    ...
    if (data.lastDate && ipfsUrl) {
      await submitGrant(data.name, data.amount, data.lastDate, ipfsUrl);
      setIsModalOpen(false);
    } else {
      console.log("Please select a date and or Upload an image");
      toast({
        title: "Error",
        description: "Please select a date and or Upload an image",
        variant: "destructive",
      });
    }
